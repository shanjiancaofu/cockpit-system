...
class UvcPreviewSource final : public CameraPreviewSource {
 public:
  explicit UvcPreviewSource(CameraUvcInputFormat input_format)
      : pipeline_(GstreamerCameraSource::kUvc, input_format) {
  }
