...
| 音频语音链路 | ALSA 抽象、AudioFrame、SPSC、VAD、分段、mock ASR/TTS、固定 sherpa-onnx/SenseVoice adapter、停止取消链路 |
...
| 真实 ASR 基线 | whisper.cpp `small` 完成历史 WSL 对照并退出产品构建；sherpa-onnx + SenseVoice INT8 在 Jetson 完成真实中文 WAV 识别，发布包不携带模型 |
