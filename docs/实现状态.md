...
| 用户车机 UI | 可用原型 | `cockpit/apps/cockpit-ui/qml`、Vehicle/Camera/Health/HMI models | 1280×720 首页、六页 Dock、完整 QML offscreen 加载、HMI 相机切页和模型测试 | 接入真实语音状态；实现受控 App Launcher/本地媒体后端；Jetson 触摸、图形栈和长稳 |
