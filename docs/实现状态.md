...
| UI 健康总览 | 可用原型 | `cockpit/core/health`、`cockpit/apps/cockpit-ui/health`、QML Dashboard/Diagnostics | health/model tests、Qt offscreen、smoke | 按 `docs/example/picture` 重做用户车机信息架构；Jetson 图形栈和长运行验证 |
