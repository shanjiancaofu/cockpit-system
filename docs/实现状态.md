...
| 本地媒体 | 部分完成 | `cockpit/apps/cockpit-ui/media` | backend 接口、固定 track ID、play/pause/resume/next/stop、失败重试、重复请求和退出回收 fixture 测试 | 现有 Audio PCM RPC 缺少流式媒体/暂停/焦点；先确定独立 owner 和音频焦点再闭环 HMI |
