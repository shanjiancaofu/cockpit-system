...
| 用户车机 UI | 可用原型 | `cockpit/apps/cockpit-ui/qml`、Vehicle/Camera/Health/HMI/Voice/AppLauncher models | 1280×720 首页、六页 Dock、真实 Voice 状态/回复/中断、固定 App ID/状态/有界生命周期、完整 QML offscreen 和模型/gRPC 测试 | 实现本地媒体后端；Jetson 触摸、图形栈和长稳 |
